...
/*   Updated: 2024/11/28 14:39:18 by schamizo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	dog->makeSound();
	dog->getBrain()->setIdea("Did him say \"Street\"??.", 0);
	dog->getBrain()->setIdea("I want to pursuit squirrels.", 1);
	std::cout << "Inside the dog's brain: " << dog->getBrain()->getIdea(0) << "\n";
	std::cout << "Inside the dog's brain: " << dog->getBrain()->getIdea(1) << "\n";
	delete	dog;
